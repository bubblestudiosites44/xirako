...
import { isAllowedReturnTo } from "@/lib/xirakoAuth";
...
export default function Login() {
  ...
  const isSpecialAuthFlow = isAllowedReturnTo(searchParams.get("return_to") || "");

  if (isSpecialAuthFlow) {
    return (
      <section className="relative min-h-screen overflow-hidden bg-[#020809]">
